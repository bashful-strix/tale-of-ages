module ToA.Resource.Icon.Foe.Foe.Basic
  ( sledge
  , soldier
  , warrior
...
gunner = Foe
  ...
  , abilities:
      ...
      , FoeAbility
          ...
          , description:
              [ Text
                  """The Gunner dashes 2, then deals 2 damage to a foe in
                  range. If a foe is at exactly range 3, they take """
              , Dice 1 D3
  ...
  , abilities:
      ...
      , FoeAbility
          ...
          , description:
              ...
              , Dice 1 D3
              , Text
                  """ positive status tokens. The Skulk may then teleport
                  3."""
              ]
          , chain: Nothing
          , insert: Nothing
...
justicar = Foe
  ...
  , description:
      [ Text
          """A rare wright using the power of light aether to punish foes
          trying to flee."""
      ]
  , notes: []
  , traits: []
  , abilities:
      ...
      , FoeAbility
          ...
          , insert: Just $ AbilityInsert
              ...
              , steps:
                  [ Step Nothing $ TriggerStep
                      [ Text "A foe ends movement 4 or more spaces away."
                      ]
                  , Step Nothing $ Eff
                      [ Text
  ...
  , abilities:
      [ FoeAbility
          ...
          , description:
              ...
              , Italic [ Text "Effect" ]
              , Text
                  """: Mark the attack target. Attacks against the marked
                  target for the rest of sombat combat gain attack """
              , Power
              , Text
                  """ and deal +2 damage on hit. This effect stacks. Lose
                  all stacks if a new target is marked."""
              ]
          , chain: Nothing
          , insert: Nothing
          }
...
rogue = Elite
  ...
  , description:
      [ Text
          """Rogues are quick witted and quick on their feet. They can be
          used to represent skilled thieves, scouts, or assassins, or
  ...
  , abilities:
      ...
      , FoeAbility
          ...
          , chain: Just $ FoeAbility
              { name: Name "Foul Play"
              , cost: One
              , tags: [ RangeTag (Range 1 3), KeywordTag (Name "Chain") ]
              , description:
                  [ Italic [ Text "Effect" ]
                  , Text
                      """: Teleport adjacent to a foe in range, then deal
                      3 damage to that foe. Can repeat the effect, but
                      must choose a different foe in range each time
