...
blightrunner = Job
  ...
  , description:
      [ Text
          ...
          updated at their meeting every five years, and updated to match
          current accounts - part of the only reason the blightlands are 
          traversable by ordinary kin at all."""
      , Newline
      , Newline
      , Text
