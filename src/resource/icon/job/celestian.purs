...
celestian = Job
  ...
  , description:
      [ Text
          ...
          written that the position of the stars affects the ebb and flow
          of Aether, something even sung about in the great Chant. Some
          take this a step further, believing that the stars affect the
          fate of mortals, the providence of the gods, and the fortune of
          those born under their sign."""
      , Newline
      , Newline
      , Text
          ...
          celestial patrons, while their mundane ones keep them busy with
          horoscopes, fortune tellings, and portents."""
      ]
