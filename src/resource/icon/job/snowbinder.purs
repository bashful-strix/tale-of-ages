...
snowbinder = Job
  ...
  , description:
      ...
      , Text
          ...
          comforting home. The Snowbinders are an honored caste that keep
          the roads clear, the storms from biting too much, and create
          warm refuges for settlements. To travelers and visitors, the
          hospitality of the northern lands is legendary. To invaders, it
          offers only a bone-biting chill."""
      ]
  , trait: Name "Icy Gust"
