...
chronomancer = Job
  ...
  , description:
      [ Text
          ...
          Guild academies, the Chronomancers are perhaps the most feared.
          Their quarry is mastery over the flow of time, a dread goal
          sought by many masters of the mortal world. At great lengths,
          and with tremendous machinery, the chronomancers examine every
          strand of Aether to determine the power of its ebb and flow."""
      , Newline
      , Newline
      , Text
