...
alchemist = Job
  ...
  , description:
      [ Text
          ...
          warrior-sages seeking to untangle the mysteries of the physical
          world, and in turn, life itself. Aether creates form. Form
          creates Aether. Nothingness and solidity are intertwined."""
      , Newline
      , Newline
      , Text
