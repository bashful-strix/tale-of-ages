...
freelancer = Job
  ...
  , description:
      ...
      , Text
          ...
          infuse with raw Aether drawn from their very souls. Each weapon
          is a relic passed down from master to student over the years,
          and can only be won in a duel with another Freelancer. It
          supernaturally inherits a fragment of the soul aether of each
          of its wielders, an unbroken line going back to the First
          Founders"""
      ]
