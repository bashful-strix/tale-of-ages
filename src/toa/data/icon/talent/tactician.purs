...
mastermind :: Talent
mastermind = Talent (Name "Mastermind")
  $ "Increase all pushes and pulls against bloodied "
      <> "characters by 1, or +2 if they are in _crisis_."

spur :: Talent
spur = Talent (Name "Spur")
  $ "Once a round, when an ally starts their turn in range 1-3, "
      <> "you man push or pull them 2 spaces, or 4 if they're in "
      <> "crisis."

fieldwork :: Talent
fieldwork = Talent (Name "Fieldwork")
  $ "Once a round, when you swap places with a character, either "
      <> "deal 2 damage to them or grant them 2 vigor. Double "
      <> "these effects if they're in crisis."
